TrailMap = {
  ...
  init: function() {
    ...
    google.setOnLoadCallback(TrailMap.initialize);
  },
  ...
  initialize: function() {
    ...
    google.maps.event.addListener(map, 'click', function(event) {
      TrailMap.addMarker(event.latLng, true);
    });
  ...
  */
  ...
  loadData: function(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      TrailMap.addMarker(latlng, false);
